...
namespace Generic.Repository.Extension.Page
{
    ...
    public static class Page
    {
        ...
        public static IPage<TValue> ToPage<TValue>(this IQueryable<TValue> listEntities, IPageConfig config)
        ...
        /// <returns></returns>
        public static IPage<TValue> ToPage<TValue>(this IQueryable<TValue> listEntities, IPageConfig config, bool pageStartInOne)
        ...
        /// <typeparam name="TValue"></typeparam>
        /// <returns></returns>
        public static IPage<TValue> ToPage<TValue>(this IQueryable<TValue> listEntities, IPageConfig config, bool pageStartInOne, string defaultSort)
        ...
        /// <typeparam name="TValue"></typeparam>
        /// <returns></returns>
        public static IPage<TValue> ToPage<TValue>(this IQueryable<TValue> listEntities, IPageConfig config, bool pageStartInOne, string defaultSort, string defaultOrder)
        ...
        /// <typeparam name="TValue"></typeparam>
        /// <returns></returns>
        public static IPage<TValue> ToPage<TValue>(this IQueryable<TValue> listEntities, IPageConfig config, bool pageStartInOne, string defaultSort, string defaultOrder, int defaultSize)
        ...
        public static IPage<TResult> ToPage<TValue, TResult>(this IQueryable<TValue> listEntities, Func<IEnumerable<TValue>, IEnumerable<TResult>> mapperTo, IPageConfig config)
        where TValue : class
        ...
        /// <typeparam name="TResult">Return type</typeparam>
        /// <returns></returns>
        public static IPage<TResult> ToPage<TValue, TResult>(this IQueryable<TValue> listEntities, Func<IEnumerable<TValue>, IEnumerable<TResult>> mapperTo, IPageConfig config, bool pageStartInOne)
        where TValue : class
        ...
        /// <typeparam name="TResult">Return type</typeparam>
        /// <returns></returns>
        public static IPage<TResult> ToPage<TValue, TResult>(this IQueryable<TValue> listEntities, Func<IEnumerable<TValue>, IEnumerable<TResult>> mapperTo, IPageConfig config, bool pageStartInOne, string defaultSort)
        where TValue : class
        ...
        /// <typeparam name="TResult">Return type</typeparam>
        /// <returns></returns>
        public static IPage<TResult> ToPage<TValue, TResult>(this IQueryable<TValue> listEntities, Func<IEnumerable<TValue>, IEnumerable<TResult>> mapperTo, IPageConfig config, bool pageStartInOne, string defaultSort, string defaultOrder)
        where TValue : class
        ...
        /// <typeparam name="TResult">Return type</typeparam>
        /// <returns></returns>
        public static IPage<TResult> ToPage<TValue, TResult>(this IQueryable<TValue> listEntities, Func<IEnumerable<TValue>, IEnumerable<TResult>> mapperTo, IPageConfig config, bool pageStartInOne, string defaultSort, string defaultOrder, int defaultSize)
        where TValue : class
